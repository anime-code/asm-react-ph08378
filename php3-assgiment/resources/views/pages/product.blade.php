                                        ...
                                        <div class="product-gallery">
                                            <div class="gallery-with-thumbs">
                                                <div class="product-image-container">
                                                    <div
                                                        class="product-full-image main-slider image-popup swiper-container-fade swiper-container-horizontal"
                                                        data-pswp-uid="1">
                                                        ...
                                                        <div class="swiper-wrapper" style="transition-duration: 0ms;">
                                                            <?php $i = 0;?>
                                                                ...
                                                                <figure
                                                                    class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-@if($i==0)active@else

                                                                        @endif"
                                                                    data-swiper-slide-index="{{$i}}"
                                                                    style="width: 440px; opacity: 1; transform: translate3d(0px, 0px, 0px); transition-duration: 0ms;">
                                                                ...
                                                                <figure class="swiper-slide swiper-slide-active"
                                                                        data-swiper-slide-index="0"
                                                                        style="width: 440px; opacity: 1; transform: translate3d(-2640px, 0px, 0px); transition-duration: 0ms;">
                                                                    <a href="{{asset($product->image)}}"
                                                                       data-size="600x600">
                                                                        <img
                                                                            src="{{asset($product->image)}}"
                                                                ...
                                                                <figure class="swiper-slide swiper-slide-next"
                                                                        data-swiper-slide-index="1"
                                                                        style="width: 440px; opacity: 0; transform: translate3d(-3080px, 0px, 0px); transition-duration: 0ms;">
                                                                    <a href="{{asset($product->image)}}"
                                                                       data-size="600x600">
                                                                        <img
                                                                            src="{{asset($product->image)}}"
                                                    ...
                                                    <div class="product-thumb-image pos-r">
                                                        <div class="nav-slider swiper-container-vertical"
                                                            ...
                                                            <div class="swiper-wrapper"
                                                                 style="transition-duration: 0ms; transform: translate3d(0px, -500px, 0px);">
                                                                <?php $i = 0?>
                                                                @foreach($galleries as $img_gallery)
                                                                    <div
                                                                        class="swiper-slide swiper-slide-duplicate"
                                                                        data-swiper-slide-index="{{$i}}"
                                                                        style="height: 85px; margin-bottom: 15px;">
                                                                        <img
                                                                            src="{{asset($img_gallery->img_url)}}"
                                                            ...
                                                            <!-- Navigation -->
                                                            <div class="swiper-arrow next" tabindex="0" role="button"
                                                                 aria-label="Next slide"><i
                                                                    class="fa fa-angle-down"></i></div>
                                                            <div class="swiper-arrow prev" tabindex="0" role="button"
                                                ...
                                                <div class="product-stock">
                                                    <form action="#">
                                                        ...
                                                        <ul class="d-flex flex-wrap align-items-center">
                                                            ...
                                                            <li>
                                                                <button type="button" class="default-btn">Add to Cart
                                                                </button>
                                                            </li>
                                                        </ul>
                                                    </form>
                                    ...
                                    <div class="col-12 col-sm-12 col-md-12">
                                        <div class="product-info mt-half">
                                            <ul class="nav nav-pills justify-content-center" id="pills-tab"
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link" id="nav_product_details" data-toggle="pill"
                                                       href="#tab_product_details" role="tab"
                                                       aria-controls="tab_product_details" aria-selected="false">Product
                                                        Details</a>
                                                </li>
                                                {{--                                                <li class="nav-item">--}}
                                                {{--                                                    <a class="nav-link" id="nav_review" data-toggle="pill"--}}
                                                ...
                                                <div class="tab-pane fade" id="tab_product_details" role="tabpanel"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="product-brand align-self-center mr-md-5">
                                                            <img src="assets/images/products/product-brand.png"
                                                                 alt="Brand Icon">
                                                        </div>
                                                    ...
                                                    <div class="product-review">
                                                        ...
                                                        <form action="#" class="review-form">
                                                            ...
                                                            <div class="buttons d-flex justify-content-end">
                                                                <button class="default-btn" type="submit">Continue
                                                                </button>
                                                            </div>
                ...
                <div class="row product-row">
                    <div class="col-12 col-sm-12 col-md-12">
                        ...
                        <div class="latest-product-wrapper pos-r">
                            <div class="element-carousel anime-element instance-0 swiper-container-horizontal"
                                ...
                                <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);">
                                        ...
                                        <div class="product-thumb">
                                            <div class="product-inner">
                                                ...
                                                <div class="product-caption">
                                                    ...
                                                    <h4 class="product-name"><a href="single-product.html">Fusion
                                                            Backpack</a></h4>
                                        ...
                                        <div class="product-thumb">
                                            <div class="product-inner">
                                                ...
                                                <div class="product-caption">
                                                    ...
                                                    <h4 class="product-name"><a href="single-product.html">Rival Field
                                                            Messenger 6</a></h4>
                                                    <p class="product-price">
                                    ...
                                    <article class="swiper-slide product-layout swiper-slide-visible"
                                             style="width: 285px;">
                                        <div class="product-thumb">
                                            <div class="product-inner">
                                                <div class="product-image">
                                                ...
                                                <div class="product-caption">
                                                    ...
                                                    <h4 class="product-name"><a href="single-product.html">Strive
                                                            Shoulder Pack</a></h4>
                                                    <p class="product-price">
                                        ...
                                        <div class="product-thumb">
                                            <div class="product-inner">
                                                <div class="product-image">
                                                    <div class="label-product label-new">New</div>
                                                    <a href="single-product.html">
                                                        <img src="assets/images/products/new/product-13.jpg"
                                                ...
                                                <div class="product-caption">
                                                    ...
                                                    <h4 class="product-name"><a href="single-product.html">Wayfarer
                                                            Messenger Bag</a></h4>
                                                    <p class="product-price">
                                                ...
                                                <div class="product-image">
                                                    ...
                                                    <a href="single-product.html">
                                                        <img src="assets/images/products/new/product-1.jpg"
                                                             alt="Rival Field Messenger" title="Rival Field Messenger">
                                                    </a>
                                                    <div class="action-links">
                                                        <a class="action-btn btn-cart" href="#" title="Add to Cart"><i
                                                                class="pe-7s-shopbag"></i></a>
                                        ...
                                        <div class="product-thumb">
                                            <div class="product-inner">
                                                <div class="product-image">
                                                    ...
                                                    <a href="single-product.html">
                                                        <img src="assets/images/products/new/product-2.jpg"
                                                             alt="Crown Summit Backpack" title="Crown Summit Backpack">
                                                    </a>
                                                    <div class="action-links">
                                                        <a class="action-btn btn-cart" href="#" title="Add to Cart"><i
                                                                class="pe-7s-shopbag"></i></a>
                                                ...
                                                <div class="product-caption">
                                                    ...
                                                    <h4 class="product-name"><a href="single-product.html">Crown Summit
                                                            Backpack</a></h4>
                                                    <p class="product-price">
                                ...
                                <div class="swiper-arrow next next-0" tabindex="0" role="button" aria-label="Next slide"
                                     aria-disabled="false"><i class="fa fa-angle-right"></i></div>
                                <div class="swiper-arrow prev prev-0 swiper-button-disabled" tabindex="0" role="button"
                                     aria-label="Previous slide" aria-disabled="true"><i class="fa fa-angle-left"></i>
                                </div>
